...
class Document_v1_20_60_50(_DocumentBase):
    VERSIONS = dict()  # ! yay
...
- name: TaskMonitorId
  ...
  in: path
    ...
    def fixOemComputerSystem(self, ctx: aiopenapi3.plugin.Document.Context) -> aiopenapi3.plugin.Document.Context:
        if ctx.url.path.endswith("OemComputerSystem.v1_1_0.yaml"):
            ctx.document["components"]["schemas"]["OemComputerSystem_v1_1_0_ComputerSystem"]["properties"][
                "DellSystem"
    ...
    def fixDellChassis(self, ctx: aiopenapi3.plugin.Document.Context) -> aiopenapi3.plugin.Document.Context:
        if ctx.url.path.endswith("Chassis.v1_26_0.yaml"):
            ctx.document["components"]["schemas"]["Chassis_v1_26_0_Chassis_Oem"]["properties"]["Dell"] = {
                "$ref": "/redfish/v1/DellOemChassis.v1_5_0.yaml#/components/schemas/DellOemChassis_v1_5_0_DellOemChassis"
            }

        if ctx.url.path.endswith("DellOemChassis.v1_5_0.yaml"):
            ctx.document["components"]["schemas"]["DellOemChassis_v1_5_0_DellOemChassis"]["properties"][
                "DellChassis"
    ...
    def fixDellUpdateService(self, ctx: aiopenapi3.plugin.Document.Context):
        if ctx.url.path.endswith("DellSoftwareInstallationService.v1_4_1.yaml"):
            ctx.document["components"]["schemas"]["DellSoftwareInstallationService_v1_4_1_Actions"]["properties"][
                "#DellSoftwareInstallationService.InstallFromURI@Redfish.Deprecated"
            ] = {"type": "string"}

    #            ctx.document["components"]["schemas"]["DellSoftwareInstallationService_v1_4_1_Actions"]["properties"]["#DellSoftwareInstallationService.InstallFromURI"]
